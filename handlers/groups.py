...
async def main(msg: Message, bot: Bot):
    ...
    if message_command:
        if is_any_from(message_command, ["повтори "]) and (msg.from_user.id == 653632008 or msg.from_user.id == 5180987097):
            await msg.delete()
...
''']):
        ...
        elif is_any_from(message_command, ["вингдингс"]) and msg.reply_to_message:
